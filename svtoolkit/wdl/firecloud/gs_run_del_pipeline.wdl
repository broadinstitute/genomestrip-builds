...
task runParallelGenotyper {
    ...
    Int adjustedDiskSize = diskSize + round(size(mdPath, "G")) + round(2.2 * size(delOutput, "G"))
...
workflow gs_run_del_pipeline_wf {
    ...
    Int genotypingParallelRecords = 5000
